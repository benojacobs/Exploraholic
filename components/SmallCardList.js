      ...
      {items.map((item) => {
        ...
        return (
          <div className={styles.smallcardwrapper}>
            ...
            {type == "hotel" && <SmallCard lang={lang} title={item.content.title} picture={item.content.mainpicture.filename} price={item.content.price} rating={item.content.rating} description={item.content.description} location={item.content.location}/>}
            {type == "restaurant" && <SmallCard lang={lang} title={item.content.title} picture={item.content.mainpicture.filename} price={item.content.price} rating={item.content.rating} description={item.content.description} location={item.content.location}/>}
